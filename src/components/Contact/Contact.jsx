        ...
        if (name && phone && message) {
            ...
            try {
                const response = await fetch(
                    'https://csyc.onrender.com/contact/send',
                    {
                        method: 'POST',
                        headers: {
        ...
        <div className="content">
            ...
            <div className="contact-container">
                ...
                <div className="contact-detail">
                    ...
                    <p className="contact-detail-options">
                        Para una atencion personalizada presencial, diríjase a:
                    </p>
                    <p>Municipalidad </p>
                    <p className="contact-detail-options">
                        También puede solicitar asesoramiento personalizado
                        telefónico llamando al:
                    </p>
                    <p>03999-422000</p>
                    <p>0800 888 2335</p>
                </div>
                ...
                <div className="contact-form">
                    <h5>
                        Para enviar consultas/sugerencias, complete el siguiente
                        formulario:
                    </h5>
                    ...
                    <Modal show={showModal} onHide={closeModal} centered>
                        ...
                        <Modal.Body>
                            <div
                                className={`alert alert-${modalVariant}`}
                                role="alert"
                            >
                                {modalMessage}
                            </div>
