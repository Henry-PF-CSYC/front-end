          ...
          <div className="cards-container">
            <div className="card-container">
              ...
              <div className="card-info">
                <p className="card-name">Ernesto Muñoz Ceniceros</p>
                <div className="card-social">
                  <div className="fs-5">Full Stack Developer</div>
            ...
            <div className="card-container">
              ...
              />
              <div className="card-info">
                <p className="card-name">Facundo Vies</p>
                <div className="card-social">
                  <p className="fs-5">Full Stack Developer</p>
                  <div className="card-link">
                    <a
            ...
            <div className="card-container">
              ...
              />
              <div className="card-info">
                <p className="card-name">Lucas González Righi</p>
                <div className="card-social">
                  <p className="fs-5">Full Stack Developer</p>
                  <div className="card-link">
                    <a
                      className="me-3"
                      href="https://www.linkedin.com/in/lucas-gonzalez-righi/"
                      target="_blank"
                    >
                      {linkedin}
                    </a>
                    <a
                      className="me-3"
                      href="https://github.com/LucasGonzalezRighi"
                      target="_blank"
                    >
                      {github}
                    </a>
            ...
            <div className="card-container">
              <img
                src="https://images.pexels.com/photos/6303681/pexels-photo-6303681.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt=""
              />
              <div className="card-info">
                <p className="card-name">Paolo Suárez</p>
                <div className="card-social">
                  <p className="fs-5">Full Stack Developer</p>
                  <div className="card-link">
                    <a
                    ...
                    <a
                      className="me-3"
                      href="https://github.com/PSuarez18"
                      target="_blank"
                    >
                      {github}
                    </a>
            ...
            <div className="card-container">
              ...
              />
              <div className="card-info">
                <p className="card-name">Jeison Duvan Ramirez</p>
                <div className="card-social">
                  <p className="fs-5">Full Stack Developer</p>
                  <div className="card-link">
                    <a
                      className="me-3"
                      href="www.linkedin.com/in/jeison-duvan-ramirez"
                      target="_blank"
                    >
                      {linkedin}
                    </a>
            ...
            <div className="card-container">
              ...
              />
              <div className="card-info">
                <p className="card-name">Cristian Barth</p>
                <div className="card-social">
                  <p className="fs-5">Full Stack Developer</p>
                  <div className="card-link">
                    <a
